...
<form method="post" action="/lesson_4/home_work/?ctrl=Admin&action=Update&id=<?php echo $this->article->id; ?>">
    ...
    <a href="/lesson_4/home_work/?ctrl=Admin&action=Admin">Назад в админ-панель</a>
</form>
</body>
</html>