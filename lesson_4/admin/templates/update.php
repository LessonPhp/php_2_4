...
<form method="post" action="/lesson_4/home_work1/admin/update.php?id=<?php echo $this->article->id; ?>">
    ...
    <a href="/lesson_4/home_work1/admin/index.php">Назад в админ-панель</a>
</form>
</body>
</html>