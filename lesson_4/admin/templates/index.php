...
<a href="/lesson_4/home_work1/admin/add.php"><p style="text-align: center;">Добавить новость</p></a><br>
<?php
...
<h1 style="text-align: center;"><?php echo $article->title; ?></h1>
    ...
    <?php if(isset($article->author_id)) { ?>
        ...
        ?>
    <a href="/lesson_4/home_work1/admin/update.php?id=<?php echo $article->id; ?>">
        <p style="text-align: center;">Обновить новость</p></a><br>
    <a href="/lesson_4/home_work1/admin/delete.php?id=<?php echo $article->id; ?>">
        <p style="text-align: center;">Удалить новость</p></a><br>
    <?php
        endforeach;
    ?>
<a href="/lesson_4/home_work1/index.php"><p style="text-align: center;">Назад на главную</p></a>
</body>
</html>