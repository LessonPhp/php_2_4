...
<body>
<a href="/lesson_4/home_work1/admin/index.php"><h3 style="text-align: center;">Админ-панель</h3></a>
<?php
...
foreach ($this->articles as $article) : ?>
    ...
    ?>
    <a href="/lesson_4/home_work1/index.php?ctrl=Index&action=Article&id=<?php echo $article->id; ?>">читать далее</a>
    <?php
endforeach;
?>
</body>
